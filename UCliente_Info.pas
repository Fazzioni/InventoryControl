...
begin
  ...
  ppLabel10.Caption:= 'Código '+IntToStr(Banco.TBClientesCodigo.Value);
  ...
  ppLabel12.Caption :='Razão Social '+Banco.TBClientesNome_Razao.Value;
 ...
 ppLabel15.Caption := Banco.TBClientesLogTypeVirtual.Value +' '+ Banco.TBClientesLogradouro.Value;
  ...
  ppLabel19.Caption :='Bairro '+Banco.TBClientesBairro.Value;
   ...
   ppLabel27.Caption :='Relatório gerado em '+DateToStr(date)+' '+FormatDateTime('HH:mm',time); 
