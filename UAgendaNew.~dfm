object FAgenda_New: TFAgenda_New
  Left = 385
  Top = 196
  Width = 513
  Height = 416
  ...
  object DB_ContatoForma: TDBLookupComboBox
    Left = 68
    Top = 286
    Width = 225
    Height = 24
    DataField = 'Contato_Forma'
    DataSource = Banco.Agenda_Source
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    ...
    KeyField = 'Codigo'
    ListField = 'Descricao'
    ListSource = Banco.Agenda_Contato
    NullValueKey = 46
    ParentFont = False
    TabOrder = 5
    OnKeyPress = DBEdit1KeyPress
  ...
  object EditDate: TDateTimePicker
    ...
    Width = 145
    Height = 25
    Date = 41961.797472638890000000
    Time = 41961.797472638890000000
    TabOrder = 0
    OnKeyPress = DBEdit1KeyPress
  end
  object EditHora: TDateTimePicker
    Left = 252
    Top = 18
    Width = 73
    Height = 25
