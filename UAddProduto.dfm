object FAddProduto: TFAddProduto
  Left = 462
  Top = 125
  Width = 537
  Height = 292
  BorderIcons = [biSystemMenu]
  Caption = 'Adicionando produto'
  Color = clBtnFace
  ...
  object TB_Estoque: TADOQuery
    Connection = Banco.ADOConnection1
    AfterOpen = TB_EstoqueAfterOpen
    BeforeClose = TB_EstoqueBeforeClose
    Parameters = <>
    SQL.Strings = (
      'Select * from Estoque')
    Left = 104
    object TB_EstoqueCodigo: TAutoIncField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'Codigo'
      ReadOnly = True
    end
    object TB_EstoqueDescricao: TWideStringField
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'Descricao'
      Size = 150
    end
    object TB_Estoqueun_virtual: TStringField
      DisplayLabel = 'Unidade'
      DisplayWidth = 29
      FieldKind = fkLookup
      FieldName = 'un_virtual'
      LookupDataSet = Banco.TBEstUn
      LookupKeyFields = 'Codigo'
      LookupResultField = 'Sinb'
      KeyFields = 'Un'
      Lookup = True
    end
    object TB_EstoqueQuantidade: TFloatField
      FieldKind = fkLookup
      FieldName = 'Quantidade'
      LookupDataSet = Banco.TBEstoque_Quant
      LookupKeyFields = 'ID_Merca'
      LookupResultField = 'Quant'
      KeyFields = 'Codigo'
      Lookup = True
    end
    object TB_EstoqueUn: TIntegerField
      Tag = 1
      DisplayLabel = 'Unidade'
      FieldName = 'Un'
    end
    object TB_EstoqueValor: TBCDField
      FieldName = 'Valor'
      currency = True
      Precision = 19
    end
